...
const reviews = [
  {
    ...
    rating: 5,
    text: "تجربة ممتازة من البداية للنهاية! الفندق كان فوق التوقعات والمرشد السياحي كان محترف جداً. أنصح الجميع بالتعامل مع Adi Tourism.",
  },
  {
    id: 2,
    name: "سارة عبدالله",
  ...
  },
  {
    ...
    rating: 5,
    text: "رحلة سيوة مع Adi Tourism غيرت نظرتي للسياحة الداخلية. تنظيم ممتاز ومرشد رائع!",
  },
];
              ...
              {reviews.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    i === activeIdx ? "w-6 bg-[#111]" : "w-2 bg-[#D1D5DB]"
                  }`}
                />
              ))}
            </div>
