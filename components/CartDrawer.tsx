              ...
              {cart.trips.length > 0 && (
                <div className="space-y-2.5">
                  ...
                  {cart.trips.map((trip) => {
                    ...
                    return (
                      <div key={trip.slug} className="bg-white rounded-2xl shadow-sm border border-[#E2E8F0]/60 overflow-hidden group">
                        {/* Trip header */}
                        <div className="flex gap-3 p-3.5">
                          ...
                          <button
                            ...
                            className="w-6 h-6 rounded-md bg-[#F8FAFC] flex items-center justify-center text-[#CBD5E1] hover:bg-red-50 hover:text-red-500 transition-colors self-start shrink-0 opacity-0 group-hover:opacity-100"
