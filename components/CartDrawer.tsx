        ...
        {totalItems > 0 && (
          <div className="border-t border-[#E2E8F0] px-6 py-5 space-y-3 bg-white">
            ...
            <Link
              href="/checkout"
              onClick={closeCart}
              className="w-full bg-[#2563EB] hover:bg-[#1d4ed8] text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-all text-sm shadow-sm hover:shadow-md mb-2"
            >
              إتمام الحجز
            </Link>
            <a
              ...
              className="w-full bg-[#25D366] hover:bg-[#20BE5C] text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all text-xs"
            >
