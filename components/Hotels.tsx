          ...
          <div className="text-center mb-10">
            ...
            <div className="w-full max-w-2xl mx-auto mb-10">
              <div className="bg-white border border-[#E2E8F0] rounded-2xl shadow-sm px-4 py-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                ...
                {/* Divider */}
                <div className="hidden sm:block w-px h-10 bg-[#E2E8F0] self-end mb-1" />
                <div className="block sm:hidden h-px w-full bg-[#E2E8F0]" />
                ...
                {/* Reset Button */}
                {(selectedCity !== "all" || filterStars !== 0) && (
                  <button
                    onClick={() => { setSelectedCity("all"); setFilterStars(0); }}
                    className="self-end mb-0.5 px-4 py-2.5 rounded-xl bg-[#FEF2F2] text-[#EF4444] text-[13px] font-semibold border border-[#FECACA] hover:bg-[#FEE2E2] transition-all whitespace-nowrap"
                  >
                    مسح الفلاتر
                  </button>
                )}
