                ...
                <div className="relative z-10 w-full max-w-[900px] px-5 md:px-14 pb-8 md:pb-12 pt-32 md:pt-48">
                    ...
                    <ScrollReveal delay={300}>
                        <div className="flex flex-wrap gap-3">
                            <button
                                onClick={onBookNow}
                                className="group inline-flex items-center gap-2 sm:gap-3 pr-5 pl-2 py-2 sm:pr-7 sm:pl-2.5 sm:py-2.5 rounded-full bg-[#2563EB] text-white text-sm sm:text-base font-semibold shadow-md hover:bg-[#1d4ed8] hover:scale-105 transition-all duration-300"
                            >
                                احجز الآن
                                <span className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white text-[#2563EB] shadow-sm shrink-0">
