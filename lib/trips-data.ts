...
export const allTrips: TripDetail[] = [
    ...
    // ═══════════════════════════════════════════════════════════════
    {
        ...
        descriptionAr:
            "انطلق في رحلة بحرية لا تُنسى إلى محمية رأس محمد الوطنية والجزيرة البيضاء الساحرة. استمتع بمشاهدة الشعاب المرجانية الملونة والأسماك الاستوائية عبر السنوركلينج، واسترخِ على متن اليخت وسط المياه الفيروزية الصافية. تشمل الرحلة وجبة غداء شهية ومشروبات منعشة طوال اليوم.",
