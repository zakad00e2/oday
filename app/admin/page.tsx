      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-[#F3F4F6] p-6">
          ...
          <div className="space-y-3">
            {[
              { label: "إضافة عرض جديد", href: "/admin/offers", color: "bg-[#0EA5E9]" },
              { label: "إضافة فندق", href: "/admin/hotels", color: "bg-[#8B5CF6]" },
              { label: "إضافة رحلة", href: "/admin/trips", color: "bg-[#F59E0B]" },
              { label: "رفع صور", href: "/admin/gallery", color: "bg-[#EC4899]" },
              { label: "إدارة المراجعات", href: "/admin/reviews", color: "bg-[#10B981]" },
            ].map((item) => (
              <Link
                key={item.label}
                href={item.href}
