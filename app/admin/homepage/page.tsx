              ...
              <div className="flex items-center justify-between border-t border-[#F9FAFB] px-3 py-2">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="rounded-lg p-2 text-[#9CA3AF] transition-colors hover:bg-[#FEF2F2] hover:text-[#DC2626] disabled:cursor-not-allowed disabled:opacity-30 sm:p-1.5"
                    title="حذف"
                  >
                    {deleting === item.id ? (
                      ...
                      <svg className="h-4 w-4 sm:h-3.5 sm:w-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
