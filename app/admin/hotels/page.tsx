              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-3 mb-1">
                  ...
                  <span className="text-sm font-semibold text-[#111] shrink-0">
                    {formatPrice(hotel.price, "ar")}<span className="text-[10px] text-[#9CA3AF] font-normal">/ليلة</span>
                  </span>
                </div>
            ...
            <div className="space-y-6">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-[#374151] mb-1.5">السعر الابتدائي (EGP/ليلة)</label>
                  ...
                  <div>
                    ...
                    {form.discount && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        ...
                        <div>
                          <label className="block text-[10px] text-[#9CA3AF] mb-1">السعر الأصلي (قبل الخصم EGP)</label>
              ...
              <section>
                ...
                <div className="space-y-2 mb-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <input type="number" value={roomInput.price || ""} onChange={(e) => setRoomInput({ ...roomInput, price: Number(e.target.value) })} placeholder="السعر (EGP)" dir="ltr" className="border border-[#E5E7EB] rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-[#111] transition-colors" />
                  </div>
                  <div className="flex gap-2">
                    ...
                    <div key={`${room.nameAr}-${index}`} className={`rounded-xl px-4 py-3 text-sm transition-colors ${editingRoomIndex === index ? "bg-[#EFF6FF] border border-[#BFDBFE]" : "bg-[#F9FAFB]"}`}>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 mr-3">
                          <span className="font-semibold text-[#111] text-xs">{formatPrice(room.price, "ar")}</span>
              ...
              <section>
                ...
                <div className="space-y-2 mb-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <input type="number" value={roomAddOnInput.price || ""} onChange={(e) => setRoomAddOnInput({ ...roomAddOnInput, price: Number(e.target.value) })} placeholder="السعر (EGP)" dir="ltr" className="border border-[#E5E7EB] rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-[#111] transition-colors" />
                  </div>
                  <div className="flex gap-2">
