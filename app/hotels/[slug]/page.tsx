    ...
    return (
        <section className="w-full px-3 md:px-5 pt-20 pb-10">
            <div className="relative overflow-hidden rounded-[2rem] h-[75vh] sm:h-[70vh] md:h-[85vh] flex flex-col justify-end mx-auto max-w-[1600px] shadow-2xl">
                ...
                <Link
                    href="/hotels"
                    className="absolute top-5 right-5 z-10 inline-flex items-center gap-2 bg-white/15 backdrop-blur-md border border-white/25 text-white text-sm font-semibold px-4 py-2 rounded-full hover:bg-white/25 transition"
                >
                ...
                <div className="relative z-10 w-full max-w-[900px] px-5 md:px-14 pb-8 md:pb-12 pt-32 md:pt-48">
                    <ScrollReveal>
                        <span className="inline-block text-[10px] sm:text-xs font-semibold tracking-widest uppercase text-[#7DD3FC] border border-[#7DD3FC]/30 bg-white/5 backdrop-blur-sm rounded-full px-3 py-1 sm:px-4 sm:py-1.5 mb-3 sm:mb-5">
                            {hotel.city}
                        </span>
                    </ScrollReveal>
                    ...
                    <ScrollReveal delay={400}>
                        <div className="flex flex-wrap items-center gap-4 sm:gap-6 mt-5 sm:mt-8 pt-4 sm:pt-6 border-t border-white/10">
                            ...
                            <div className="flex items-center gap-2 text-white/80 text-sm font-semibold">
                                يبدأ من <span className="text-[#7DD3FC] text-lg font-bold">${hotel.price.toLocaleString("en-US")}</span>
                                <span className="text-white/50 font-normal">/ ليلة</span>
                            </div>
                        </div>
                    </ScrollReveal>
                </div>
