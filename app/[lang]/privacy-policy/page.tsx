...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    description: isAr
      ? "سياسة الخصوصية الخاصة بـ Oday Tourism. تعرف على كيفية جمع بياناتك الشخصية واستخدامها وحمايتها."
      : "Privacy policy for Oday Tourism. Learn how your personal data is collected, used, and protected.",
    path: "/privacy-policy",
    noIndex: false,
  });
}
...
export default async function PrivacyPolicyPage({
  ...
  const document = getPrivacyPolicyContent(locale);
